class Langswitch {
    constructor() {
        this.switcher = {
            ...
            "about-text1": "I'm 29 years old, working for The Embassy of Hungary, in consular section. For a long time I worked in spheres, crossed to visa information support, tried myself in different ways, searched and learned a lot of different information.",
            ...
            "about-text3": "I analized huge mass of information about direction of growth and decided to study for Front-end development. I've been offered to study the Rolling Scopes School from my friend, which successfully graduated that school couple years ago and working as Front-end/Back-end development.",
            ...
            "emb-title": "2018 - that time - Embassy of Hungary",
            ...
            "ru": {
                ...
                "about-text1": "Мне 28 лет, работаю в Посольстве Венгрии, в консульском отделе. Долгое время работал в сферах, которые пересекаются с визовой и информационной поддержкой, пробовал себя в разных направлениях, искал и изучал много различной информации.",
